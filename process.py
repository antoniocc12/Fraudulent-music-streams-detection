...
def batch_enrich(processes = None):
...
# Copy data back to GCP bucket -----------------------------------


def mv_data_to_bucket():
	...
	cp_cmd = "gsutil cp -r  %s %s"%(current_folder, bucket_id_url)
